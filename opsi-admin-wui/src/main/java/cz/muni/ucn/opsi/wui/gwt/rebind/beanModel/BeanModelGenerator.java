 ...
 */
package cz.muni.ucn.opsi.wui.gwt.rebind.beanModel;
...
import cz.muni.ucn.opsi.wui.gwt.client.beanModel.BeanModelE;
...
import cz.muni.ucn.opsi.wui.gwt.client.beanModel.BeanModelMarker;
import cz.muni.ucn.opsi.wui.gwt.client.beanModel.BeanModelMarker.BEAN;
        ...
        if (returnType != null && returnType.isAssignableTo(oracle.getType(List.class.getName()))
          ...
          if (beans.contains(params[0])) {
            ...
            sw.println("java.util.List list2 = " + BeanModelLookup.class.getCanonicalName() + ".get().getFactory("
                + params[0].getQualifiedSourceName() + ".CLASS_NAME).createModel((java.util.Collection) list);");
            sw.outdent();
          ...
          if (beans.contains(returnType)) {
            ...
            sw.println("        nestedModel = " + BeanModelLookup.class.getCanonicalName() + ".get().getFactory("
                + returnType.getQualifiedSourceName() + ".CLASS_NAME).createModel(value);");
